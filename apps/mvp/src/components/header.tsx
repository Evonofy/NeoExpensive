    ...
    content: (
      <ul className="dropdown--submenu">
        <div className="dropdown--submenu--wrapper">
          <div className="dropdown--submenu--item--wrapper">
            <div className="dropdown--submenu--title">
              ...
              <li className="dropdown--submenu--item">
                <Link to="/items?category=tech&query=hardware" className="dropdown--submenu--link">
                  Peças (Hardware)
                </Link>
              </li>
            </div>
            ...
            <li className="dropdown--submenu--item">
              <Link to="/items?category=tech&query=cpus" className="dropdown--submenu--link">
                Processadores
              </Link>
            </li>
            <li className="dropdown--submenu--item">
              <Link to="/items?category=tech&query=gpus" className="dropdown--submenu--link">
                Placas de Vídeo
              </Link>
            </li>
            <li className="dropdown--submenu--item">
              <Link to="/items?category=tech&query=motherboard" className="dropdown--submenu--link">
                Placas-Mãe
              </Link>
            </li>
            <li className="dropdown--submenu--item">
              <Link to="/items?category=tech&query=ram" className="dropdown--submenu--link">
                Memórias
              </Link>
            </li>
            <li className="dropdown--submenu--item">
              <Link to="/items?category=tech&query=hard-drive" className="dropdown--submenu--link">
                Disco Rígido HD/SSD
              </Link>
            </li>
            <li className="dropdown--submenu--item">
              <Link to="/items?category=tech&query=powersupply" className="dropdown--submenu--link">
                Fontes
              </Link>
            </li>
          </div>
          ...
          <div className="dropdown--submenu--item--wrapper">
            <div className="dropdown--submenu--title">
              ...
              <li className="dropdown--submenu--item">
                <Link to="/items?category=accessories" className="dropdown--submenu--link">
            ...
            <li className="dropdown--submenu--item">
              <Link to="/items?category=accessories&query=headphones" className="dropdown--submenu--link">
                Fones de Ouvido
              </Link>
            </li>
            <li className="dropdown--submenu--item">
              <Link to="/items?category=accessories&query=keyboards" className="dropdown--submenu--link">
                Teclados
              </Link>
            </li>
            <li className="dropdown--submenu--item">
              <Link to="/items?category=accessories&query=mouse" className="dropdown--submenu--link">
                Mouses
              </Link>
            </li>
            <li className="dropdown--submenu--item">
              <Link to="/items?category=accessories&query=controllers" className="dropdown--submenu--link">
                Controles
              </Link>
            </li>
          </div>
        ...
        <div className="dropdown--submenu--section">
          ...
          <Link to="/items?category=computers" className="dropdown--submenu--section--cta">
        ...
        <div className="dropdown--submenu--wrapper">
          <div className="dropdown--submenu--item--wrapper">
            ...
            <div className="dropdown--submenu--title">
              <li className="dropdown--submenu--item--console">
                <Link
                  to="/items?category=consoles&query=xbox"
                  className="dropdown--submenu--link dropdown--submenu--title--link"
                >
                  Xbox
                </Link>
              </li>
            ...
            <li className="dropdown--submenu--item dropdown--submenu--align--center">
              <Link to="/items?category=consoles&query=xbox&type=consoles" className="dropdown--submenu--link">
                Consoles
              </Link>
            </li>
            <li className="dropdown--submenu--item dropdown--submenu--align--center">
              <Link to="/items?category=consoles&query=xbox&type=accessories" className="dropdown--submenu--link">
                Acessórios
              </Link>
            </li>
            <li className="dropdown--submenu--item dropdown--submenu--align--center">
              <Link to="/items?category=consoles&query=xbox&type=games" className="dropdown--submenu--link">
                Jogos
              </Link>
            </li>
          </div>
          ...
          <div className="dropdown--submenu--item--wrapper">
            ...
            <div className="dropdown--submenu--title">
              <li className="dropdown--submenu--item--console">
                <Link
                  to="/items?category=consoles&query=playstation"
                  className="dropdown--submenu--link dropdown--submenu--title--link"
                >
                  PlayStation
                </Link>
            ...
            <li className="dropdown--submenu--item dropdown--submenu--align--center">
              <Link to="/items?category=consoles&query=playstation&type=consoles" className="dropdown--submenu--link">
                Consoles
              </Link>
            </li>
            <li className="dropdown--submenu--item dropdown--submenu--align--center">
              <Link
                to="/items?category=consoles&query=playstation&type=accessories"
            ...
            <li className="dropdown--submenu--item dropdown--submenu--align--center">
              <Link to="/items?category=consoles&query=playstation&type=games" className="dropdown--submenu--link">
                Jogos
              </Link>
            </li>
          </div>
          ...
          <div className="dropdown--submenu--item--wrapper">
            ...
            <div className="dropdown--submenu--title">
              <li className="dropdown--submenu--item--console">
                <Link
                  to="/items?category=consoles&query=nintendo"
                  className="dropdown--submenu--link dropdown--submenu--title--link"
                >
                  Nintendo
                </Link>
            ...
            <li className="dropdown--submenu--item dropdown--submenu--align--center">
              <Link to="/items?category=consoles&query=nintendo&type=consoles" className="dropdown--submenu--link">
                Consoles
              </Link>
            </li>
            <li className="dropdown--submenu--item dropdown--submenu--align--center">
              <Link to="/items?category=consoles&query=nintendo&type=accessories" className="dropdown--submenu--link">
                Acessórios
              </Link>
            </li>
            <li className="dropdown--submenu--item dropdown--submenu--align--center">
              <Link to="/items?category=consoles&query=nintendo&type=games" className="dropdown--submenu--link">
                Jogos
              </Link>
            </li>
          </div>
...
const socialIcons = [
  {
    name: 'facebook',
    link: 'https://www.facebook.com/neo-expertise-102995498833851',
    svg: (
  ...
  {
    name: 'instagram',
    link: 'https://www.instagram.com/neo_expensive',
    svg: (
      <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  {
    name: 'twitter',
    link: 'https://twitter.com/ExpensiveNeo',
    svg: (
      <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
...
export const Header = () => {
  ...
  const headerActions = [
    {
      ...
      value: theme,
      image: Palette,
      imageAlt: 'Theme Changer Palette',
      action: useCallback(() => {
        if (theme === 'dark') {
          setTheme('light');
        } else {
  ...
  useClickOutside(
    navRef,
    useCallback((event) => {
      const closeButton = document.querySelector('.hamburger--header--button');

      if (closeButton?.contains(event.target as HTMLElement)) {
        return;
      }
  ...
  const handleSearchItem = (event: FormEvent | undefined) => {
    if (event) {
      event.preventDefault();
    }

    navigate(`/item?query=${search}`);
  };
  // useEffect(() => {
  //   const userChoices = document.querySelectorAll<HTMLElement>('.user--controls--customer--choices--item')!;
  //   const findChoice = (name: string, choice: HTMLElement) => {
  //     return choice.querySelector('a')?.innerHTML === name;
  //   };

  //   const handleClickChoice = (choice: HTMLElement) => {
  //     const isProfile = findChoice('Perfil', choice);
  //     const isExit = findChoice('Sair', choice);

  //     const isLogin = findChoice('Entrar', choice);
  //     const isRegister = findChoice('Registrar-se', choice);
  ...
  //     if ((isProfile || isExit) && !isLoggedIn) {
  ...
  //     choice.addEventListener('click', () => handleClickChoice(choice));
  //   });

  //   return () => {
  //     userChoices.forEach((choice) => choice.removeEventListener('click', () => handleClickChoice(choice)));
  //   };
  // }, [navigate]);
    ...
    <React.Fragment>
      <header className="hamburger--header">
        <div className="hamburger--header--items">
          <button onClick={() => setIsMobileNavOpen((open) => !open)} className="hamburger--header--button">
            <span className="hamburger--header--button--span"></span>
          </button>

          <nav ref={navRef} className="hamburger--nav">
            <ul className="hamburger--nav--list">
              {navLinks.map(({ name, link, image, imageAlt, desktopOnly }) => {
                if (desktopOnly) {
                  return;
                }

                return (
                  <div key={name} className="hamburger--nav--list--wrapper">
                    <img className="hamburger--nav--list--wrapper--image" src={image} alt={imageAlt} />
                    <li className="hamburger--nav--item">
                      <Link to={link} className="hamburger--nav--item--link">
                        {name}
                      </Link>
                    </li>
                  </div>
              ...
              {headerActions.map(({ name, value, action, image, imageAlt }) => {
                return (
                  <div key={name} className="hamburger--nav--list--wrapper">
                    <img className="hamburger--nav--list--wrapper--image" src={image} alt={imageAlt} />
                    <li className="hamburger--nav--item">
                      <button onClick={action} className="hamburger--nav--item--button">
                        {value}
                      </button>
                    </li>
                  </div>
              ...
              {userLinks.map(({ name, link, image, imageAlt }) => {
                return (
                  <div key={name} className="hamburger--nav--list--wrapper">
                    <img className="hamburger--nav--list--wrapper--image" src={image} alt={imageAlt} />

                    <li className="hamburger--nav--item">
                      <Link to={link} className="hamburger--nav--item--button">
                        {name}
                      </Link>
                    </li>
                  </div>
          ...
          <Link to="/" className="hamburger--header--items--logo" data-reset>
          ...
          <Link to="/cart" className="hamburger--header--items-cart" data-reset>
            <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M35.9375 35.9375H13.6364L8.18782 5.97049C8.12236 5.61047 7.93262 5.28485 7.65169 5.05039C7.37075 4.81593 7.01644 4.6875 6.65052 4.6875H3.125"
                stroke="white"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
              ...
              />
              <path
                d="M12.2159 28.125H36.7385C37.4704 28.125 38.179 27.8681 38.7409 27.3992C39.3027 26.9303 39.6822 26.2791 39.8131 25.559L42.1875 12.5H9.375"
                stroke="white"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
        ...
        <form onSubmit={handleSearchItem} className="hamburger--header--search">
          <label className="hamburger--header--search--label">
            <input
              className="hamburger--header--search--label--input"
              type="text"
              placeholder=" "
              value={search}
          ...
          <button onClick={handleSearchItem} className="hamburger--header--search--button" data-reset>
            <svg
              className="hamburger--header--search--svg"
              width="50"
              height="50"
              viewBox="0 0 50 50"
              fill="none"
            ...
            >
              <path
                d="M22.6562 39.0625C31.7172 39.0625 39.0625 31.7172 39.0625 22.6562C39.0625 13.5953 31.7172 6.25 22.6562 6.25C13.5953 6.25 6.25 13.5953 6.25 22.6562C6.25 31.7172 13.5953 39.0625 22.6562 39.0625Z"
                stroke="white"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M34.2566 34.2579L43.7489 43.7502"
                stroke="white"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      <header className="desktop--header">
        <div className="social--icons">
          {socialIcons.map(({ name, link, svg }) => {
            return (
              <a key={name} href={link} data-reset target="_blank" rel="noreferrer">
                {svg}
              </a>
            );
          })}
        ...
        <nav className="desktop--nav">
          <ul role="list" className="dropdown">
            {navLinks.map(({ name, link, content, customElement }) => {
              if (customElement) {
                return <div key={name}>{customElement}</div>;
              }

              return (
                <li key={name} className="dropdown--item">
                  <Link className="dropdown--item--link" to={link}>
                    {name}
                  </Link>
        ...
        <div className="user--controls">
          <div className="user--controls--header--search">
            <button onClick={handleSearchItem} className="user--controls--header--search--button" data-reset>
              <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M22.6562 39.0625C31.7172 39.0625 39.0625 31.7172 39.0625 22.6562C39.0625 13.5953 31.7172 6.25 22.6562 6.25C13.5953 6.25 6.25 13.5953 6.25 22.6562C6.25 31.7172 13.5953 39.0625 22.6562 39.0625Z"
                  stroke="white"
            ...
            <div className="user--controls--header--search--data">
              <label className="user--controls--header--search--data--label">
                <input
                  className="user--controls--header--search--data--label--input"
                  type="text"
                  placeholder=" "
                  value={search}
                  onChange={(event) => setSearch(event.target.value)}
          ...
          <div className="user--controls--customer">
            <Link to="/profile" className="user--controls--customer--button" data-reset>
              <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <div className="user--controls--customer--choices">
              {headerActions.map(({ name, value, action, image, imageAlt }) => (
                <div key={name} className="user--controls--customer--choices--item">
                  <img className="user--controls--customer--choices--icon" src={image} alt={imageAlt} />
                  <button
                    onClick={action}
                    className="user--controls--customer--choices--button theme--switcher--button"
                  >
                    {value}
                  </button>
                </div>
              ...
              {userLinks.map(({ name, link, image, imageAlt }) => (
                <div key={name} className="user--controls--customer--choices--item">
                  <img className="user--controls--customer--choices--icon" src={image} alt={imageAlt} />
                  <Link to={link} className="user--controls--customer--choices--link">
                    {name}
                  </Link>
                </div>
              ))}
          ...
          <Link to="/cart" id="cart" data-reset>
            <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M35.9375 35.9375H13.6364L8.18782 5.97049C8.12236 5.61047 7.93262 5.28485 7.65169 5.05039C7.37075 4.81593 7.01644 4.6875 6.65052 4.6875H3.125"
                stroke="white"
