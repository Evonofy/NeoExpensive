    ...
    <footer className="footer">
      <section className="footer--aboutus">
        ...
        <p className="footer--paragraph">
          A Neo Expertise, empresa de venda dos mais diversos hardwares foi criada para satisfazer suas necessidades e
          lhe entregar produtos com o comprometimento de oferecê-los com a maior qualidade possível.
        </p>
      ...
      <section className="footer--contact-us">
        ...
        <ul className="footer--contact-list">
          <li>
            <a href="https://github.com/VitorGouveia" rel="noopener noreferrer" target="_blank">
              Vitor Gouveia
            </a>
            <br />
          </li>
          <li>
            <a href="https://github.com/Espalmer" rel="noopener noreferrer" target="_blank">
              Vinicius Aquino
            </a>
            <br />
          </li>
          <li>
            <a href="https://github.com/AtomicFeasT" rel="noopener noreferrer" target="_blank">
              Thiago Lisboa
            </a>
          </li>
        </ul>
