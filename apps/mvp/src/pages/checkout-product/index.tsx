...
export default function CheckoutProduct() {
  ...
  const { addAddress, removeAddress, addCard, removeCard, createOrder, products } = useContext(ProductsContext);
  ...
  const total = useMemo(() => {
    ...
    const totalProductsPrice = product?.price! * quantity;
  ...
  }, [coupons, product?.price, quantity]);
            ...
            <ul>
              <li>
                ...
                <div>
                  ...
                  <Button disabled={quantity === 1} onClick={() => setQuantity((quantity) => quantity - 1)}>
                    -
                  </Button>
                </div>
              </li>
