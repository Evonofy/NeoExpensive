...
async function loadProducts() {
  const products = await fetch('neo-expertise/old/js/data/products.json');
...
async function loadBrands() {
  const brands = await fetch('neo-expertise/old/js/data/brands.json');
...
async function loadDepartments() {
  const departments = await fetch('neo-expertise/old/js/data/departments.json');
